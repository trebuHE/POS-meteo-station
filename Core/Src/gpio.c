...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, GPS_WAKEUP_Pin|GPS_RESET_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : RF_GDO0_Pin RF_GDO2_Pin */
  GPIO_InitStruct.Pin = RF_GDO0_Pin|RF_GDO2_Pin;
