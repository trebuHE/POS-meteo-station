...
- **SN-x** - węzeł pomiarowy,
- **GN-x** - urządzenie centralne,
- **INT-x** - interfejsy.
...
| :--- | :--- | :--- | :--- |
| SN-01 | Pomiar temperatury | Węzeł pomiarowy ma mierzyć temperaturę z dokładnością do 1 st. Celsjusza. | T |
| SN-02 | Pomiar ciśnienia | Węzeł pomiarowy ma mierzyć ciśnienie atmosferyczne z dokładnością do 1 hPa. | T |
| SN-03 | Pomiar siły wiatru| Węzeł pomiarowy ma mierzyć siłę wiatru z dokładnością do 1 m/s. | T |
| SN-04 | Pomiar kierunku wiatru | Węzeł pomiarowy ma mierzyć kierunek wiatru z dokładnością do 1 st. kątowego. | T |
| SN-05 | Pomiar opadów deszczu | Węzeł pomiarowy ma mierzyć sumę dobową opadów deszczu z dokładnością do 1 l/m&sup2;.| T |
| SN-06 | Transmisja radiowa | Węzeł pomiarowy ma przesyłać sformatowane ramki danych do urządzenia centralnego drogą radiową | D |
| SN-07 | Autodiagnoza | Węzeł pomiarowy powinien wykrywać problemy ze swoim działaniem. | T |
| SN-08 | Zgłaszanie problemów | Węzeł pomiarowy może zgłaszać użytkownikowi problemy ze swoim działaniem. | D |
| GN-01 | Odbiór danych | Urządzenie centralne ma odbierać ramki danych nadawane przez węzły pomiarowe. | T |
| GN-02 | Formatowanie danych | Urządzenie centralne ma formatować dane w sposób zgodny z bazą danych. | I |
| GN-03 | Archiwizacja danych | Urządzenie centralne ma archiwizować zebrane dane w bazie danych.| I |
| GN-04 | Samostart | Urządzenie centralne powinno wznowić normalną pracę po utracie zasilania bez ingerencji człowieka w czasie krótszym niż 1 minuta. | T |
